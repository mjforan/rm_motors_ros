docker build . -t ros2_control_demos -f Dockerfile/Dockerfile && docker run -it --rm --name ros2_control_demos --net host ros2_control_demos ros2 launch ros2_control_demo_example_1 rrbot.launch.py gui:=false

rviz2 -d rrbot/rviz/rrbot.rviz
